...
export function ProfileDialog({ user, trigger, open: controlledOpen, onOpenChange: setControlledOpen }: ProfileDialogProps) {
  ...
  const handleUploadParameters = async (file: UppyFile<Record<string, unknown>, Record<string, unknown>>) => {
