...
import { useUser, useLogout } from "@/hooks/use-auth.js";
      ...
      <div className="container flex h-16 items-center justify-between">
        <div className="flex items-center gap-2">
          ...
          <nav className="hidden md:flex items-center gap-6 ml-10">
            ...
            {isSeeker && <NavLink href="/seeker/profile">My Profile</NavLink>}
        ...
        <Sheet open={open} onOpenChange={setOpen}>
          ...
          <SheetContent side="right" className="flex flex-col gap-4 pt-10">
            ...
            {isSeeker && <MobileLink href="/seeker/profile">My Profile</MobileLink>}
